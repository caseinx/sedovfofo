...
const menuLists = [
    {
        ...
        menuListItems: [
            ...
            {
                itemName: 'Страх Милана',
                itemImgSrc: 'img/menu/pizza/pizza-3.png',
                itemImgAlt: 'Страх Милана пицца фото',
    ...
    },
    {
        ...
        menuListItems: [
            ...
            },
            {
                ...
                itemImgAlt: 'Лайт-купаж салат фото',
                itemComposition: 'Козье молоко, укроп',
                itemPrice: '2000р',
            },
            {
                itemName: 'Креветочный нажор',
                itemImgSrc: 'img/menu/salads/salad-5.png',
                itemImgAlt: 'Креветочный нажор салат фото',
    ...
    },
    {
        ...
        menuListItems: [
            ...
            {
                itemName: 'Papa Карлоу',
                itemImgSrc: 'img/menu/drinks/drink-2.png',
                itemImgAlt: 'Papa Карлоу напиток фото',
            ...
            },
            {
                ...
                itemImgAlt: 'Фреш Вотер напиток фото',
